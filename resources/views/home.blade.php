...
<html lang="en">
    <head>
        ...
        />
        <link
            href="{{ asset('vendor/owl.carousel/assets/owl.carousel.min.css') }}"
            rel="stylesheet"
        />
        <link
                                            ...
                                            <script>
                                                function payWithPaystack() {
                                                    var handler = PaystackPop.setup(
                                                        {
                                                            key:
                                                                "pk_test_774b88fe5735cb10af1c710265a14e51f99124c5",
                                                            email:
                                                                "davidalenoghena@gmail.com",
                                                            amount: 10000,
                                                            currency: "NGN",
                                                            ref:
                                                                "" +
                            ...
                            <article class="entry">
                                ...
                                <div class="entry-content">
                                    ...
                                    <div class="read-more">
                                        <a
                                            id="more"
                                            onclick="$('.details').slideToggle(function(){$('#more').html($('.details').is(':visible')?'See Less Details':'Read More');});"
                                            >Read More</a
                                        >
                                    </div>
                                </div>
        ...
        <footer id="footer">
            ...
            <div class="container d-md-flex py-4">
                <div class="mr-md-auto text-center text-md-left">
                    <div class="copyright">
                        &copy; Copyright <strong><span>KiaKia</span></strong
                        >. All Rights Reserved
                    </div>
                </div>
                <div
